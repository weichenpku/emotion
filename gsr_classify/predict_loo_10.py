...
if __name__ == "__main__":
    ...
    for feaidx in range(pca_comp_num):
        ...
        for idx in range(repeat_time):
            ...
            ret = predict(eeg[0:216,:], eeg[216:, :], 1000, 5, rd_eeg)
        ...
        acc1 = (eeg_classify_result[0][0] + eeg_classify_result[1][1] + eeg_classify_result[2][2])/(8*6*repeat_time)
        ...
        for idx in range(repeat_time):
            ...
            for i in range(USERS):
                print(i,eeg_result[i])
        acc2 = (eeg_classify_result[0][0] + eeg_classify_result[1][1] + eeg_classify_result[2][2])/(8*6*repeat_time)
